...
// '@basic-live-cam/invites' collection key
...
// '@basic-live-cam/invites' value encoding
const collection0_enc = getEncoding('@basic-live-cam/invite/hyperdb#0')

// '@basic-live-cam/invites' reconstruction function
...
// '@basic-live-cam/invites' key reconstruction function
...
// '@basic-live-cam/invites'
const collection0 = {
  name: '@basic-live-cam/invites',
  id: 0,
  version: 1,
  encodeKey (record) {
    const key = [record.id]
...
// '@basic-live-cam/videos' collection key
...
// '@basic-live-cam/videos' value encoding
const collection1_enc = getEncoding('@basic-live-cam/video/hyperdb#1')

// '@basic-live-cam/videos' reconstruction function
...
// '@basic-live-cam/videos' key reconstruction function
...
// '@basic-live-cam/messages' collection key
...
// '@basic-live-cam/messages' value encoding
const collection2_enc = getEncoding('@basic-live-cam/message/hyperdb#2')

// '@basic-live-cam/messages' reconstruction function
...
// '@basic-live-cam/messages' key reconstruction function
...
function resolveCollection (name) {
  switch (name) {
    case '@basic-live-cam/invites': return collection0
    case '@basic-live-cam/videos': return collection1
    case '@basic-live-cam/messages': return collection2
    default: return null
  }
}
