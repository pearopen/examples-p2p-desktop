...
class Router {
  ...
  add (name, handler) {
    switch (name) {
      case '@basic-live-cam/add-writer':
        this._handler0 = handler
        break
      case '@basic-live-cam/add-invite':
        this._handler1 = handler
        break
      case '@basic-live-cam/add-video':
  ...
  _checkAll () {
    assert(this._handler0 !== null, 'Missing handler for "@basic-live-cam/add-writer"')
    assert(this._handler1 !== null, 'Missing handler for "@basic-live-cam/add-invite"')
    assert(this._handler2 !== null, 'Missing handler for "@basic-live-cam/add-video"')
    assert(this._handler3 !== null, 'Missing handler for "@basic-live-cam/add-message"')
  }
...
const route0 = {
  name: '@basic-live-cam/add-writer',
  id: 0,
  enc: getEncoding('@basic-live-cam/writer')
}

const route1 = {
  name: '@basic-live-cam/add-invite',
  id: 1,
  enc: getEncoding('@basic-live-cam/invite')
}

const route2 = {
  name: '@basic-live-cam/add-video',
  id: 2,
  enc: getEncoding('@basic-live-cam/video')
}

const route3 = {
  name: '@basic-live-cam/add-message',
  id: 3,
  enc: getEncoding('@basic-live-cam/message')
}
