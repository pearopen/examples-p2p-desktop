...
const methods = new Map([
  ['@basic-photo-backup/videos', 0],
  [0, '@basic-photo-backup/videos'],
  ['@basic-photo-backup/add-video', 1],
  [1, '@basic-photo-backup/add-video'],
  ['@basic-photo-backup/messages', 2],
  [2, '@basic-photo-backup/messages'],
  ['@basic-photo-backup/add-message', 3],
  [3, '@basic-photo-backup/add-message']
])
...
class HRPC {
  constructor(stream) {
    ...
    this._requestEncodings = new Map([
      ['@basic-photo-backup/videos', getEncoding('@basic-photo-backup/videos')],
      ['@basic-photo-backup/add-video', c.string],
      ['@basic-photo-backup/messages', getEncoding('@basic-photo-backup/messages')],
      ['@basic-photo-backup/add-message', getEncoding('@basic-photo-backup/add-message')]
    ])
  ...
  videos(args) {
    return this._callSync('@basic-photo-backup/videos', args)
  }

  addVideo(args) {
    return this._callSync('@basic-photo-backup/add-video', args)
  }

  messages(args) {
    return this._callSync('@basic-photo-backup/messages', args)
  }

  addMessage(args) {
    return this._callSync('@basic-photo-backup/add-message', args)
  }

  onVideos(responseFn) {
    this._handlers['@basic-photo-backup/videos'] = responseFn
  }

  onAddVideo(responseFn) {
    this._handlers['@basic-photo-backup/add-video'] = responseFn
  }

  onMessages(responseFn) {
    this._handlers['@basic-photo-backup/messages'] = responseFn
  }

  onAddMessage(responseFn) {
    this._handlers['@basic-photo-backup/add-message'] = responseFn
  }
  ...
  _requestIsSend(command) {
    return [
      ...
      '@basic-photo-backup/add-video',
      '@basic-photo-backup/messages',
      '@basic-photo-backup/add-message'
    ].includes(command)
  }
}
