...
// @basic-photo-backup/invite/hyperdb#0
const encoding7 = {
  preencode(state, m) {
    c.buffer.preencode(state, m.invite)
    c.buffer.preencode(state, m.publicKey)
...
// @basic-photo-backup/video/hyperdb#1
const encoding8 = {
  preencode(state, m) {
    c.string.preencode(state, m.name)
    c.string.preencode(state, m.type)
...
// @basic-photo-backup/message/hyperdb#2
const encoding9 = {
  preencode(state, m) {
    c.string.preencode(state, m.text)
    state.end++ // max flag is 1 so always one byte
...
function getEncoding(name) {
  switch (name) {
    case '@basic-photo-backup/writer':
      return encoding0
    case '@basic-photo-backup/invite':
      return encoding1
    case '@basic-photo-backup/video':
      return encoding2
    case '@basic-photo-backup/videos':
      return encoding3
    case '@basic-photo-backup/message':
      return encoding4
    case '@basic-photo-backup/messages':
      return encoding5
    case '@basic-photo-backup/add-message':
      return encoding6
    case '@basic-photo-backup/invite/hyperdb#0':
      return encoding7
    case '@basic-photo-backup/video/hyperdb#1':
      return encoding8
    case '@basic-photo-backup/message/hyperdb#2':
      return encoding9
    default:
