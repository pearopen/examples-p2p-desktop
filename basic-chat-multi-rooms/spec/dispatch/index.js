...
class Router {
  ...
  add (name, handler) {
    switch (name) {
      case '@basic-chat-multi-rooms/add-writer':
...
const route0 = {
  name: '@basic-chat-multi-rooms/add-writer',
  id: 0,
  enc: getEncoding('@basic-chat-multi-rooms/writer')
}

const route1 = {
  name: '@basic-chat-multi-rooms/add-invite',
  id: 1,
  enc: getEncoding('@basic-chat-multi-rooms/invite')
}
