...
// '@basic-chat-multi-rooms/invites' collection key
...
// '@basic-chat-multi-rooms/invites' value encoding
const collection0_enc = getEncoding('@basic-chat-multi-rooms/invite/hyperdb#0')

// '@basic-chat-multi-rooms/invites' reconstruction function
...
// '@basic-chat-multi-rooms/invites' key reconstruction function
...
// '@basic-chat-multi-rooms/invites'
const collection0 = {
  name: '@basic-chat-multi-rooms/invites',
  id: 0,
  encodeKey (record) {
    const key = [record.id]
