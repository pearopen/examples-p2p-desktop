...
// @basic-chat-multi-rooms/message/hyperdb#1
const encoding5 = {
  preencode(state, m) {
    c.string.preencode(state, m.text)
    state.end++ // max flag is 1 so always one byte
...
function getEncoding(name) {
  switch (name) {
    case '@basic-chat-multi-rooms/writer':
      return encoding0
    ...
    case '@basic-chat-multi-rooms/invite/hyperdb#0':
      return encoding4
    case '@basic-chat-multi-rooms/message/hyperdb#1':
      return encoding5
    default:
