...
const methods = new Map([
  ['@basic-video-stream/videos', 0],
  [0, '@basic-video-stream/videos'],
  ['@basic-video-stream/add-video', 1],
  [1, '@basic-video-stream/add-video'],
  ['@basic-video-stream/messages', 2],
  [2, '@basic-video-stream/messages'],
  ['@basic-video-stream/add-message', 3],
  [3, '@basic-video-stream/add-message']
])
...
class HRPC {
  constructor(stream) {
    ...
    this._requestEncodings = new Map([
      ...
      ['@basic-video-stream/add-video', c.string],
