...
class Router {
  ...
  add (name, handler) {
    switch (name) {
      case '@basic-chat-identity/add-writer':
        this._handler0 = handler
        break
      case '@basic-chat-identity/add-invite':
        this._handler1 = handler
        break
      case '@basic-chat-identity/add-message':
  ...
  _checkAll () {
    assert(this._handler0 !== null, 'Missing handler for "@basic-chat-identity/add-writer"')
    assert(this._handler1 !== null, 'Missing handler for "@basic-chat-identity/add-invite"')
    assert(this._handler2 !== null, 'Missing handler for "@basic-chat-identity/add-message"')
  }
...
const route0 = {
  name: '@basic-chat-identity/add-writer',
  id: 0,
  enc: getEncoding('@basic-chat-identity/writer')
}

const route1 = {
  name: '@basic-chat-identity/add-invite',
  id: 1,
  enc: getEncoding('@basic-chat-identity/invite')
}

const route2 = {
  name: '@basic-chat-identity/add-message',
  id: 2,
  enc: getEncoding('@basic-chat-identity/message')
}
