...
// '@basic-chat-identity/invites' collection key
...
// '@basic-chat-identity/invites' value encoding
const collection0_enc = getEncoding('@basic-chat-identity/invite/hyperdb#0')

// '@basic-chat-identity/invites' reconstruction function
...
// '@basic-chat-identity/invites' key reconstruction function
...
// '@basic-chat-identity/invites'
const collection0 = {
  name: '@basic-chat-identity/invites',
  id: 0,
  version: 1,
  encodeKey (record) {
    const key = [record.id]
...
// '@basic-chat-identity/messages' collection key
...
// '@basic-chat-identity/messages' value encoding
const collection1_enc = getEncoding('@basic-chat-identity/message/hyperdb#1')

// '@basic-chat-identity/messages' reconstruction function
...
// '@basic-chat-identity/messages' key reconstruction function
...
const collection1 = {
  name: '@basic-chat-identity/messages',
  id: 1,
  version: 1,
  encodeKey (record) {
    const key = [record.id]
...
function resolveCollection (name) {
  switch (name) {
    case '@basic-chat-identity/invites': return collection0
    case '@basic-chat-identity/messages': return collection1
    default: return null
  }
}
